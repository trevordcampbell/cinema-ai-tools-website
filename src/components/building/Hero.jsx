...
import { AppScreen } from '@/components/pocket-template/AppScreen';
import { AppStoreLink } from '@/components/pocket-template/AppStoreLink';
import { PocketButton } from '@/components/pocket-template/Button';
import { Container } from '@/components/pocket-template/Container';
import { PhoneFrame } from '@/components/pocket-template/PhoneFrame';
    ...
    <div {...props}>
      ...
      >
        ...
        <defs>
          ...
          >
            <stop stopColor='#f97516' />
            <stop offset='1' stopColor='#f97516' stopOpacity='0' />
          </linearGradient>
        </defs>
      </svg>
      <svg
      ...
      <Container>
        <div className='lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20'>
          <div className='relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6'>
            <a href='#' className='mb-10 inline-flex space-x-6'>
              <span className='rounded-full bg-primary-600/10 px-3 py-1 text-sm font-semibold text-primary-500 ring-1 ring-inset ring-primary-600/10'>
                🎬 Pre-Release V-0.10.3
              </span>
              <span className='inline-flex items-center space-x-2 text-sm font-medium text-minorColor dark:text-minorColor-darkMode'>
                <span>See current progress</span>
                <ChevronRightIcon
            ...
            <h1 className='text-5xl font-medium tracking-tight text-majorColor dark:text-majorColor-darkMode'>
              Next-Generation Tools for Editors, Directors, Filmmakers and
              Studios
            </h1>
            <p className='mt-6 text-lg text-minorColor dark:text-minorColor-darkMode'>
              Shave weeks and months off your production time with our
              integrated suite of tools that puts the power of an entire
              Hollywood production studio at your fingertips.
            </p>
            <Button className='mt-8' variant='primary' rightIcon={HiArrowRight}>
              Learn More
            </Button>
          </div>
          <div className='relative mt-10 sm:mt-20 lg:col-span-5 lg:row-span-2 lg:mt-0 xl:col-span-6'>
            {/* NOTE - Keep BackgroundIllustration or modify it for something else */}
            {/* <BackgroundIllustration className="absolute left-1/2 top-4 h-[1026px] w-[1026px] -translate-x-1/3 stroke-gray-300/70 [mask-image:linear-gradient(to_bottom,white_20%,transparent_75%)] sm:top-16 sm:-translate-x-1/2 lg:-top-16 lg:ml-12 xl:-top-14 xl:ml-0" /> */}
            <div className='-mx-4 h-[448px] px-9 [mask-image:linear-gradient(to_bottom,white_60%,transparent)] sm:mx-0 lg:absolute lg:-inset-x-10 lg:-bottom-20 lg:-top-10 lg:h-auto lg:px-0 lg:pt-10 xl:-bottom-32'>
              {/* FIXME - Remove the Phone Frame and replac with a different animation / video */}
              <div className='mx-auto flex h-72 max-w-[366px] items-center justify-center rounded-3xl border-4 bg-red-500/50'>
                Image / Video Content Here
              </div>
              {/* CODESNIPPET - This used to be the phone frame for the app display */}
              {/* <PhoneFrame className="mx-auto max-w-[366px]" priority>
                <AppDemo />
              </PhoneFrame> */}
            </div>
          </div>
          {/* NOTE - This is the "featured in" section for endorsements */}
          {/* <div className="relative -mt-4 lg:col-span-7 lg:mt-0 xl:col-span-6">
            <p className="text-center text-sm font-semibold text-minorColor dark:text-minorColor-darkMode lg:text-left">
              As featured in
            </p>
            <ul
              role="list"
