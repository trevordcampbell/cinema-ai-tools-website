...
import { Logomark } from '@/components/pocket-template/Logo';
...
function Plan({
  ...
  return (
    <section
      className={clsx(
        'flex flex-col overflow-hidden rounded-3xl p-6 shadow-lg shadow-zinc-900/10',
        featured
          ? 'order-first bg-zinc-800 lg:order-none'
    ...
    >
      <h3
        className={clsx(
          ...
          featured
            ? 'text-majorColor dark:text-majorColor-darkMode'
            : 'text-minorColor dark:text-minorColor-darkMode'
        )}
      >
      ...
      {/* FIXME - Change this button to use the built in generic button if possible, or change variant within this button */}
      <PocketButton
        href={button.href}
...
export function Pricing() {
  ...
  return (
    <section
      ...
      className='border-t-2 border-zinc-200 py-20 dark:border-zinc-800 sm:py-32'
    >
      <Container>
        <div className='mx-auto max-w-2xl text-center'>
          <h2
            id='pricing-title'
            className='text-3xl font-medium tracking-tight text-majorColor dark:text-majorColor-darkMode'
          >
