...
//           className={clsx(
//             'h-5 w-5',
//             rating > index ? ' fill-primary-400' : 'fill-zinc-300 dark:fill-zinc-700'
//           )}
//         />
//       ))}
//     </div>
...
//     <figure
//       className={clsx(
//         'animate-fade-in rounded-3xl bg-white dark:bg-zinc-900/50 dark:border-4 dark:border-zinc-800 p-6 opacity-0 shadow-md shadow-zinc-900/10',
//         className
//       )}
//       style={{ animationDelay }}
//       {...props}
//     >
//       <blockquote className="text-majorColor dark:text-majorColor-darkMode">
//         <StarRating rating={rating} />
//         <p className="mt-4 text-lg font-bold leading-6 before:content-['“'] after:content-['”']">
//           {title}
//         </p>
//         <p className="mt-3 text-base leading-7">{body}</p>
//       </blockquote>
//       <figcaption className="mt-3 text-sm text-minorColor dark:text-minorColor-darkMode before:content-['–_']">
//         {author}
//       </figcaption>
//     </figure>
//   )
...
// // FIXME - Fix the 'Unexpected empty arrow function' error here
...
//         </>
//       )}
//       <div className="pointer-events-none absolute inset-x-0 top-0 h-32 bg-gradient-to-b from-gray-50 dark:from-zinc-950" />
//       <div className="pointer-events-none absolute inset-x-0 bottom-0 h-32 bg-gradient-to-t from-gray-50 dark:from-zinc-950" />
//     </div>
//   )
// }
...
//         <h2
//           id="reviews-title"
//           className="text-3xl font-medium tracking-tight text-majorColor dark:text-majorColor-darkMode sm:text-center"
//         >
//           Everyone is changing their life with Pocket.
//         </h2>
//         <p className="mt-2 text-lg text-minorColor dark:text-minorColor-darkMode sm:text-center">
